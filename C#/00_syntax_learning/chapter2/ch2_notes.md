...
- руль в машине один, но руление (использование интерфейса) осуществляется через передачу прямого дейсвия/передачу с усилением/реечную передачу (разл. реализация)
...
Использование целочисленных переменных - ![примере 2](ch2exmp2.cs).
...
Псевдокод для ![пример 4](ch2exmp4.cs):
...
Псевдокод для ![пример 5](ch2exmp5.cs):
```
...
<table border="1" align=center>
    <caption>C# reserved keywords</caption>
        <tr align=center>
...
<table border="1" align=center>
    <caption>C# contextual keywords</caption>
        <tr align=center>
